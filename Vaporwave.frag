// from https://www.shadertoy.com/view/4ldGz4
...
#else /*/*defined(GL_EXT_shader_texture_lod)*/
vec4 textureLod(  sampler2D   s, vec2 c, float b)          { return texture2D(s,c,b); }
#endif /*defined(GL_EXT_shader_texture_lod)*/
